# Generated by Django 5.0.4 on 2024-06-25 21:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alias', models.CharField(default='None', max_length=254)),
                ('email', models.EmailField(max_length=254, unique=True)),
                ('Ai', models.BooleanField(default=False)),
                ('Occupied', models.BooleanField(default=False)),
                ('language', models.CharField(default='en', max_length=254)),
                ('paddle_color', models.CharField(default='#00FF99', max_length=254)),
                ('pong_color', models.CharField(default='#141414', max_length=254)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('winner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='won_matches', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
